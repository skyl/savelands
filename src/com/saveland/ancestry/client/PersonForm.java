...
public class PersonForm extends DialogBox implements ClientDataObserver {
    ...
    private AutocompletePlacesMapWidgetDrop wMap;
    ...
    private void attachUI() {
        ...
        fatherSelect.getElement().setPropertyString("placeholder",
                "Father's Name");
        motherSelect.getElement().setPropertyString("placeholder",
                "Mother's Name");
        // map
        wMap = new AutocompletePlacesMapWidgetDrop();
        // notes
        notes = new TextArea();
